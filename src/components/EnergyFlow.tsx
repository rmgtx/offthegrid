      ...
      <div
        className={`relative w-28 h-28 sm:w-32 sm:h-32 rounded-3xl flex items-center justify-center mb-4 transition-all duration-300 ${
          accent
            ...
            : "bg-white border border-border shadow-[0_1px_3px_rgba(0,0,0,0.04)]"
        }`}
      >
        {icon}
      </div>
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8" ref={ref}>
        ...
        >
          ...
          <h2 className="font-display text-4xl sm:text-5xl text-navy leading-[1.1] mb-5">
            Simple technology.{" "}
            <span className="text-amber italic">Powerful protection.</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-4 mb-20">
            ...
            <FlowStep
              ...
              icon={
                <svg viewBox="0 0 64 64" className="w-14 h-14">
                  {/* House body */}
                  <rect x="16" y="30" width="32" height="24" rx="2" fill="#0B1426" />
                  {/* Roof */}
                  <path d="M12 32 L32 14 L52 32" stroke="#0B1426" strokeWidth="3" fill="#0B1426" strokeLinejoin="round" />
                  {/* Door */}
        ...
        <div className="grid sm:grid-cols-3 gap-8 max-w-4xl mx-auto mb-16">
          {[
            ...
            >
              ...
              <h4 className="font-heading font-semibold text-navy mt-2 mb-2">
                {step.title}
              </h4>
